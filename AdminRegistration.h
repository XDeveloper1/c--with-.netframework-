...
namespace sca {
	...
	/// <summary>
	/// Summary for AdminRegistraion
	/// </summary>
	public ref class AdminRegistraion : public System::Windows::Forms::Form
	{
	public:
		AdminRegistraion(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"Admin Registertion Form";
			...
			this->label2->Click += gcnew System::EventHandler(this, &AdminRegistraion::label2_Click);
			// 
			// textBox1
			// 
			...
			this->label3->Click += gcnew System::EventHandler(this, &AdminRegistraion::label3_Click_1);
			// 
			// label4
			// 
			...
			this->label10->Click += gcnew System::EventHandler(this, &AdminRegistraion::label10_Click);
			// 
			// monthCalendar1
			// 
			...
			this->dobdone->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->dobdone->Location = System::Drawing::Point(755, 360);
			this->dobdone->Name = L"dobdone";
			this->dobdone->Size = System::Drawing::Size(107, 43);
			this->dobdone->TabIndex = 19;
			...
			this->Name = L"AdminRegistraion";
			this->Text = L"AdminRegistraion";
			this->Load += gcnew System::EventHandler(this, &AdminRegistraion::AdminRegistraion_Load);
